...
class ingreso(models.Model):
    ...
    cont = models.FileField(upload_to='ingre/%Y/%m/%d', null=True, blank=True, verbose_name="Pdf")
    cont2 = models.FileField(upload_to='ingreexcel/%Y/%m/%d', null=True, blank=True, verbose_name="Excel")
